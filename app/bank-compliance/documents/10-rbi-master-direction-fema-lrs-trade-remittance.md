...
# Master Direction on Liberalised Remittance Scheme & FEMA (RBI/FED/2015-16/16)
...
* **TCS Thresholds:** Remittances exceeding ₹7 Lakh per fiscal year attract 20% TCS (except 5% for education financed via loan).

## Chapter II: Export & Import Trade Data Monitoring (EDPMS / IDPMS)

### Clause 2.1: Export Data Processing and Monitoring System (EDPMS)
* **Realization Timeline:** Full export value must be realized and repatriated to India within **nine (9) months** from the date of export.
* **Overdue Export Tracking:** If export proceeds are not realized within 9 months, AD banks must issue cautionary notices and report on EDPMS.

### Clause 2.2: Import Data Processing and Monitoring System (IDPMS)
AD banks must ensure Bill of Entry (BoE) settlement on IDPMS within **six (6) months** of remittance for import of goods.
