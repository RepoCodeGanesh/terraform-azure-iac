...
| **[ROADMAP.md](../../ROADMAP.md#phase-11)** | **Phase 11** | LLMOps Skill Bridge Phase 1 (Trivy CVE Scan, Pod SecurityContext, KQL Azure Monitor Workbook, Ollama Sovereign SLM, Langfuse Tracing, Token Budget, FastMCP Server, AI Red-Team) (**Status: ✅ COMPLETED**). | [`ROADMAP.md`](../../ROADMAP.md) & [`app/bank-compliance/`](../../app/bank-compliance/) |
| **[ROADMAP.md](../../ROADMAP.md#phase-12)** | **Phase 12** | LLMOps Skill Bridge Phase 2 (LangGraph StateGraph Cyclic Orchestrator, REST API v2, Sovereign GPU vLLM Architecture & Benchmark) (**Status: ✅ COMPLETED**). | [`ROADMAP.md`](../../ROADMAP.md) & [`workloads/bank-compliance-ai-aks/`](../../workloads/bank-compliance-ai-aks/) |
