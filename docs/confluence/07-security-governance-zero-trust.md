# 07. Enterprise Security, Zero-Trust Architecture & Governance
...
```text
 ...
 [ Azure APIM Gateway ] --> IP Rate Limiting (20 req/min) & WAF Sanitization
         |
         v (Spoke VNet / Azure CNI Overlay)
 [ Workload Ingress ]
...
## 3. AI Safety & Regulatory Data Protection (DPDP Act 2023)
...
## 4. Kubernetes DevSecOps & OPA Gatekeeper Guardrails
...
## 6. Enterprise Management Groups & Policy-as-Code (CAF Standard)
