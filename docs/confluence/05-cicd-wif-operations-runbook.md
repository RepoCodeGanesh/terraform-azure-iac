# 05. Dual CI/CD, Workload Identity & Operations Runbook
...
+--------------------------------------------------------------------------------------------------+
 ...
 |
 +-- TIER 2: ENTERPRISE IAC GOVERNANCE & AUDIT (Azure DevOps -- Standby / Governance Driver)
...
| :--- | :--- | :--- | :--- | :--- |
| **Bootstrap** | `bootstrap` | `BOOTSTRAP_CLIENT_ID` | `DevOpsUniverse-Terraform-bootstrap`<br>`934ab83b-2f61-475e-bdbc-85c9eaed83e6` | `repo:RepoCodeGanesh/terraform-azure-iac:environment:bootstrap-prod` |
...
| **Shared Services** | `shared-services` | `SHARED_CLIENT_ID` | `DevOpsUniverse-Terraform-shared-services`<br>`580ffcfd-51ee-4dc3-9204-d03cb438ff82` | `repo:RepoCodeGanesh/terraform-azure-iac:environment:shared-services-prod` |
| **Apps (TaxBot & BankC)** | `app-prod` | `APP_CLIENT_ID` | `DevOpsUniverse-Terraform-app-prod`<br>`99ab7987-3989-46c3-bae9-92279be16608` | `repo:RepoCodeGanesh/terraform-azure-iac:environment:bank-compliance-prod` |
